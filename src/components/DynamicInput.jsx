    ...
    return (
      <div className="ml-4 border-l-2 border-zinc-700 pl-4 my-2">
        ...
        <div className="mt-2 flex gap-2">
          <button
            onClick={() => handleAddArrayItem("string")}
            className="text-xs bg-zinc-800 hover:bg-zinc-700 text-blue-400 px-2 py-1 rounded border border-zinc-700"
          >
            + Add String
          </button>
          <button
            onClick={() => handleAddArrayItem("object")}
            className="text-xs bg-zinc-800 hover:bg-zinc-700 text-purple-400 px-2 py-1 rounded border border-zinc-700"
          >
            + Add Object
          </button>
        </div>
